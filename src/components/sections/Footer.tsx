...
export function Footer() {
  return (
    <footer className="bg-surface-container-lowest dark:bg-surface-container-low border-t border-border dark:border-outline-variant/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-8 lg:py-10 flex flex-col md:flex-row justify-between items-center gap-5">
        <div className="flex flex-col items-center md:items-start gap-1.5">
          <div className="flex items-center gap-2">
        
            <span className="font-(family-name:--font-sora) text-lg font-bold text-text-primary">
              Opportunities-platform.
            </span>
          </div>
          <p className="font-(family-name:--font-dm-sans) text-xs text-text-secondary">
            © 2024 Opportunities-platform. All rights reserved.
          </p>
        </div>
