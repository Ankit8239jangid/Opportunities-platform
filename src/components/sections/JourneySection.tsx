      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-10">
        <AnimatedSection>
          <div className="text-center mb-10 lg:mb-14">
            <h2 className="font-[family-name:var(--font-sora)] text-2xl sm:text-[32px] font-semibold leading-tight text-text-primary mb-3">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-1/2 left-0 w-full h-0.5 bg-outline-variant/20 dark:bg-outline-variant/10 -translate-y-1/2" />
            ...
            {steps.map((step) => (
              ...
              >
                <motion.div
                  ...
                  className="w-14 h-14 lg:w-16 lg:h-16 rounded-full bg-surface-container-lowest dark:bg-surface-container border-4 border-primary dark:border-primary-fixed flex items-center justify-center text-primary dark:text-primary-fixed font-bold text-lg font-[family-name:var(--font-sora)] shadow-xl"
                >
                  {step.number}
                </motion.div>
                <h3 className="font-[family-name:var(--font-sora)] text-lg lg:text-xl font-semibold text-text-primary">
                  {step.title}
                </h3>
